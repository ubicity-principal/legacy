...
var saveString = 'Save';
var AoINamePrompt = 'Please enter a name for the new area:';
...
function geolocationError(error) {
	Ext.Msg.alert('', "Could not retrieve your current location: " + error.message + ". Using the specified default location.");
...
function calculateBoundingBox(bbox) {
	...
	*/  
	//  countUrl = 'http://envirofi.ait.ac.at/GeoCouch/treecommon/_design/main/_spatial/trees';
	    countUrl = 'http://enviro7.ait.ac.at/GeoCouch/' + 'treecommon/' + '_design/main/' + '_spatial/' + 'trees';
...
function getBoundingBoxDownloadsize(bbox) {
	...
	if(hasInternetConnection()){
		var url = 'http://enviro7.ait.ac.at/~envirofi/GeoCouchUtils/' + 'getCacheSize.pl?';
