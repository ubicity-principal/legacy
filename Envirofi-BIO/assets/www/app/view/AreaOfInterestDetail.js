...
//				docked: 'top',
				...
				listeners : {
			        tap : function() {
			            ...
			            if(AoI_refresh(aoidata)) {
			            	Ext.Msg.alert('Info', 'Refresh may take some time depending on your connection bandwidth.', Ext.emptyFn);
			            } else {
			            	Ext.Msg.alert('Info', 'Sorry, refresh did fail!', Ext.emptyFn);
			            }
			        }
			    }
			},
			...
			},
			{
				...
				listeners : {
			        tap : function() {
			            Ext.Msg.confirm('', 'Do you really want to delete the maps cached for this area?',function(buttonId, value, opt) {
			                if (buttonId == 'yes') {
			                    var aoidata = Ext.getCmp('aoidetails').getData();
				...
				listeners : {
			        tap : function() {
			        	...
			        	if(AoI_delete(aoidata)) {
							Ext.Msg.alert('Info', 'Successfully deleted area!', Ext.emptyFn);
							// get AoI-store
			            	...
			            	Ext.Msg.alert('Info', 'Sorry, could not delete area!', Ext.emptyFn);
			            }
			...
			},
			{
				...
				items: [
				    ...
				    },
				    {
                        ...
                        labelWrap: true,
						options: [
							{text: 'Time ^', value: 'created_asc'},
							{text: 'Time v', value: 'created_desc'},
							{text: 'Distance ^', value: 'distance_asc'},
							{text: 'Distance v', value: 'distance_desc'},
							{text: 'Status', value: 'visited'}
						],
				    	flex: 1,
				    	usePicker: false,
				    	listeners: {
