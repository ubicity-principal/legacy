...
Ext.define('treeapp.view.TreeDetail', {
    ...
    config: {
        //title: '@treeapp.view.TreeDetail.Title@',
		id: 'treedetail',
			...
			},
			{
				...
				items: [
                   { xtype: 'spacer' },
                   {
					   ...
					   text: '<span>@treeapp.view.TreeDetail.addObservationButtonLabel1@</span><br><span>@treeapp.view.TreeDetail.addObservationButtonLabel2@</span>'
					},
					{
						itemId: 'openExternalAppButton',
					    text: '<span>@treeapp.view.TreeDetail.openExternalAppButtonLabel1@</span><br><span>@treeapp.view.TreeDetail.openExternalAppButtonLabel2@</span>'
					},
					{
						itemId: 'createtag',
					    text: '<span>@treeapp.view.TreeDetail.createTagButtonLabel1@</span><br><span>@treeapp.view.TreeDetail.createTagButtonLabel2@</span>'
					},
					{ xtype: 'spacer' }
				]
			}
