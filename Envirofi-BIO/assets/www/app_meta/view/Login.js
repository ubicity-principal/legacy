...
//			flex: 1,
			...
			items: [
				{
					xtype: 'container',
					html: '<h1>ENVIROFI-BIO</h1><h5 style="padding-right: 3px; text-align: right; margin-bottom: -40px;">@mdafapp.client.version@</h5><img src="img/envirofi.png" width="220" height="220">',
					...
					items: [
							{
								...
								label: '<div style="width:100%;white-space:normal;">@treeapp.view.Login.loginaccounttype@</div>',
								//usePicker: false,
								options : [],
					            height: 50,
					            listeners: {
							...
							},
							{
								...
								label: '<div style="width:100%;white-space:normal;">@treeapp.view.Login.loginemailselect@</div>',
								//usePicker: false,
								options : [],
					            height: 50
							},
